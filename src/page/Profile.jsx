...
const Profile = () => {
  return (
    <section className="relative bg-[radial-gradient(circle_at_top,rgba(0,128,128,0.7)_0%,transparent_50%)] text-white  h-[600px] flex flex-col md:flex-row items-center justify-center gap-2 px-6 md:px-15">
